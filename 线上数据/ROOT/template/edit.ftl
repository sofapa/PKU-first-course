...
<#include "/include/header.ftl"><div class="g-doc">
    ...
    <div class="n-public">
		...
		<span style="display:none">${product.price}</span><#assign view= product.price/100>
            <div class="fmitem">
                <label class="fmlab">价格：</label>
                <div class="fmipt">
                	
                    <input class="u-ipt price" id="pri" name="price" value="${view}"/>元
...
function supper(){
    var str = document.getElementById('pri').value;
    str = str.replace(/,/g,'');
	document.getElementById('pri').value=str;	
}
</script>
</body>
</html>
