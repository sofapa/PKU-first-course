    ...
    <table class="m-table m-table-row n-table g-b3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <span style="display:none">${x.buyPrice}</span>
                <#assign view = x.buyPrice/100>
                <td><span class="v-unit">¥</span><span class="value">${view}</span></td>
                <#assign total = total + view*x.buyNum>
